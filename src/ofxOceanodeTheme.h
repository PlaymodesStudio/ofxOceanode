...
void StyleColorsOceanode(ImGuiStyle* dst = NULL)
{
	...
	colors[ImGuiCol_SliderGrab]             = ImVec4(1.00f, 0.40f, 0.0f, 0.50f);
	colors[ImGuiCol_SliderGrabActive]       = ImVec4(1.00f, 0.40f, 0.0f, 0.50f);
    colors[ImGuiCol_Button]                 = ImVec4(0.26f, 0.26f, 0.26f, 0.50f);
    colors[ImGuiCol_ButtonHovered]          = ImVec4(0.35f, 0.35f, 0.35f, 0.50f);
    colors[ImGuiCol_ButtonActive]           = ImVec4(0.55f, 0.55f, 0.55f, 0.50f);
