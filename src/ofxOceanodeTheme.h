...
void StyleColorsOceanode(ImGuiStyle* dst = NULL)
{
    ...
    colors[ImGuiCol_PopupBg]                = ImVec4(0.50f, 0.50f, 0.50f, 1.00f);
    colors[ImGuiCol_Border]                 = ImVec4(0.13f, 0.13f, 0.13f, 0.50f);
    ...
    colors[ImGuiCol_Button]                 = ImVec4(0.22f, 0.22f, 0.22f, 0.00f);
