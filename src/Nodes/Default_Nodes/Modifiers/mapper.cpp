...
void mapper::setup() {
    ...
    parameters->add(minInput.set("MinInput", {0}, {0}, {1}));
    parameters->add(maxInput.set("MaxInput", {1}, {0}, {1}));
    parameters->add(minOutput.set("MinOutput", {0}, {0}, {1}));
    parameters->add(maxOutput.set("MaxOutput", {1}, {0}, {1}));
